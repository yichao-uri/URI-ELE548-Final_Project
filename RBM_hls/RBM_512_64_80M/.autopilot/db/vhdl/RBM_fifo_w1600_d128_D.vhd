...
entity RBM_fifo_w1600_d128_D is
    generic (
        MEM_STYLE         : string  := "distributed";
        DATA_WIDTH        : integer := 1600;
...
architecture arch of RBM_fifo_w1600_d128_D is

    -- component
    component RBM_fifo_w1600_d128_D_ram is
    generic (
        MEM_STYLE  : string  := "distributed";
        DATA_WIDTH : natural := 1600;
...
begin
----------------------- Instantiation -----------------------
    U_RBM_fifo_w1600_d128_D_ram : RBM_fifo_w1600_d128_D_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity RBM_fifo_w1600_d128_D_ram is
    generic (
        MEM_STYLE   : string  := "distributed";
        DATA_WIDTH  : integer := 1600;
        ADDR_WIDTH  : integer := 7;
...
architecture arch of RBM_fifo_w1600_d128_D_ram is
