...
set xo_kernel_name "RBM"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/ubuntu20/Xilinx/ELE548/Restricted_Boltzmann_Machine/RBM_hls/RBM_512_64_80M"
set debug_dir "/home/ubuntu20/Xilinx/ELE548/Restricted_Boltzmann_Machine/RBM_hls/RBM_512_64_80M/.debug"
set xo_hls_files_dir ""
set hdl_module_list {RBM_regslice_both
RBM_regslice_both
RBM_regslice_both
...
set Interfaces {
    ...
    stream_sigmoid_switch {
        type "axi4stream"
        mode "slave"
        port_prefix "stream_sigmoid_switch"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    ap_clk {
        ...
        buses "stream_control_in stream_sigmoid_switch vector_in_len vector_out_len stream_vector_in stream_weight_in stream_bias_in stream_vector_out"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 12.5 machine 64 combinational 0 latency 42 II x}
