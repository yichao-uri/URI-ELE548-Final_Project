...
architecture arch of RBM_fifo_w10_d128_A is

    -- component
    component RBM_fifo_w10_d128_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_RBM_fifo_w10_d128_A_ram : RBM_fifo_w10_d128_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity RBM_fifo_w10_d128_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 10;
        ADDR_WIDTH  : integer := 7;
...
architecture arch of RBM_fifo_w10_d128_A_ram is
