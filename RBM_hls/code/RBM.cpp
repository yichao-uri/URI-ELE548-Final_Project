...
#pragma HLS DATAFLOW
	...
	hls_thread_local hls::stream<control_t, 128>  control_ch1;
	hls_thread_local hls::stream<control_t, 128>  control_ch2;
	hls_thread_local hls::stream<control_t, 128>  control_ch3;
	hls_thread_local hls::stream<rbm_size_t, 128> vector_in_len_ch1;
	hls_thread_local hls::stream<rbm_size_t, 128> vector_in_len_ch2;
	hls_thread_local hls::stream<rbm_size_t, 128> vector_in_len_ch3;
	hls_thread_local hls::stream<rbm_size_t, 128> vector_out_len_ch1;
	hls_thread_local hls::stream<rbm_size_t, 128> vector_out_len_ch2;
	hls_thread_local hls::stream<rbm_size_t, 128> vector_out_len_ch3;
	hls_thread_local hls::stream<buffer_data_t, 1024>  buffer_out;
	hls_thread_local hls::stream<systolic_data_t, 128> systolic_input;
	hls_thread_local hls::stream<systolic_index_t, 128> stream_weight_row_index;
#pragma HLS BIND_STORAGE variable=stream_weight_row_index type=fifo impl=lutram
	hls_thread_local hls::stream<ap_uint10, 128> stream_bias_col_index;
	hls_thread_local hls::stream<pe_valid_t, 128> stream_pe_valid;
	hls_thread_local hls::stream<systolic_weight_t, 128> stream_weight_out;
#pragma HLS BIND_STORAGE variable=stream_weight_out type=fifo impl=lutram
	hls_thread_local hls::stream<data_b_t, 128> stream_bias_out;
	hls_thread_local hls::stream<stream_data_h_t, 128>  systolic_out;
...
#pragma HLS ARRAY_PARTITION variable=data_tag_delay_line type=complete
	...
	if(stream_control_in.empty() == bool(0)){
		...
		if(systolic_input_temp.valid){
			...
			static systolic_index_t weight_row_index_out = {0};
