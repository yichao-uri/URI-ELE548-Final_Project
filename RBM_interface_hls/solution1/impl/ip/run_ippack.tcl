...
set Library     "hls"
set IPName      "RBM_interface"
set Version     "1.0"
set DisplayName "Rbm_interface"
set Revision    "2113178318"
...
set xo_kernel_name "RBM_interface"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/ubuntu20/Xilinx/ELE548/Restricted_Boltzmann_Machine/RBM_interface_hls/solution1"
set debug_dir "/home/ubuntu20/Xilinx/ELE548/Restricted_Boltzmann_Machine/RBM_interface_hls/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {RBM_interface_fpext_32ns_64_2_no_dsp_1
...
## Variables
set Top "RBM_interface"
set TopNoPrefix "RBM_interface"
...
set Interfaces {
    ...
    axis_sigmoid_switch_in {
        type "axi4stream"
        mode "slave"
        port_prefix "axis_sigmoid_switch_in"
        has_tready "1"
        ports {
            TDATA 8
            TLAST 1
    ...
    axis_vector_in_len_in {
        type "axi4stream"
        mode "slave"
        port_prefix "axis_vector_in_len_in"
        has_tready "1"
        ports {
            TDATA 16
            TLAST 1
    ...
    axis_vector_out_len_in {
        type "axi4stream"
        mode "slave"
        port_prefix "axis_vector_out_len_in"
        has_tready "1"
        ports {
            TDATA 16
            TLAST 1
    ...
    stream_sigmoid_switch_in {
        type "axi4stream"
        mode "master"
        port_prefix "stream_sigmoid_switch_in"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    stream_vector_in_len_in {
        type "axi4stream"
        mode "master"
        port_prefix "stream_vector_in_len_in"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    stream_vector_out_len_in {
        type "axi4stream"
        mode "master"
        port_prefix "stream_vector_out_len_in"
        has_tready "1"
        ports {
            TDATA 16
        }
...
## System Info
set user_parameters_list {clk_period 12.5 machine 64 combinational 0 latency 4 II 1}
...
source -notrace "/home/ubuntu20/Softwares/Xilinx/Vitis_HLS/2022.2/common/scripts/ipxhls.tcl"
